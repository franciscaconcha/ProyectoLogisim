...
public class InvisibleCurvedArrow extends CurvedArrow {
	 ...
	 *            are rather curvy
	 */
	public InvisibleCurvedArrow(int x1, int y1, int x2, int y2, float curvy, TransitionObject t) {
	 ...
	 *            are rather curvy
	 */
	public InvisibleCurvedArrow(Point start, Point end, float curvy, TransitionObject t) {
