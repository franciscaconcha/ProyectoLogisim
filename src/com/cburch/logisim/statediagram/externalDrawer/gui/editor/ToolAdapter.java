...
public class ToolAdapter extends SuperMouseAdapter {
	 ...
	 * 
	 * @param pane
	 *            the diagram pane this tool adapter is listening to
	 */
	public ToolAdapter(DiagramPane pane) {
		this.pane = pane;
	}
	...
	/** The diagram pane that this tool adapter is part of. */
	private DiagramPane pane = null;
}
