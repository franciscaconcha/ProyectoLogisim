...
public class Frame extends LFrame implements LocaleListener {
	...
	class MyProjectListener implements ProjectListener, LibraryListener, CircuitListener, PropertyChangeListener,
	      ChangeListener {
	...
	public Frame( Project proj ) {
		...
		testButton.addActionListener( new ActionItemError2(proj));
